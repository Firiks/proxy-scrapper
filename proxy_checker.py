"""
Modified version of https://github.com/ricerati/proxy-checker-python
"""
...
class ProxyChecker:
    ...
    def __init__(self, timeout: int = 5000, verbose: bool = False):
        ...
        # Checks
        if self.ip == "":
            print("ERROR: https://ip.me/ is down. This module won't work")
            exit(1)
    ...
    def get_ip(self) -> str:
        '''
            Gets the IP checking it in https://ip.me/
            Return: IP or "" if it couldn't find anything
        '''
        r = self.send_query(url='https://ip.me/')
    ...
    def check_proxy(self, proxy: str, check_country: bool = True, check_address: bool = False, check_all_protocols: bool = False, \
        ...
        for retry in range(retries):
            for protocol in protocols_to_test:
                ...
                timeout += r['timeout'] # response timout in ms
